...
import venity from '@/app/assets/images/venity.png';
import { RegisterDialog } from "@/app/constants/RegisterDialog";
        ...
        <div className="relative isolate overflow-hidden  px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Regiter as a Vendor and start selling your products on our platform.
              Here we Konnect you to your customers. <br/> No more middleMan and no more stress.
            </p>
